...
## 核心组件
- knowledge-detail.tsx：知识详情展示与编辑的核心组件，负责富文本渲染、媒体展示、编辑态切换、保存与版本管理、评论与附件交互、状态与事件桥接。
...
## 结论
knowledge-detail 组件以清晰的层次结构与明确的职责边界，实现了知识详情的展示与编辑闭环。通过 API 分层、鉴权控制与完善的用户体验设计（草稿、版本、评论、附件），满足复杂业务场景需求。建议在后续迭代中持续优化渲染性能、离线能力与多端一致性。
